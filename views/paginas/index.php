...
<section class="resumen">
    <div class="resumen__grid">
        <div data-aos="<?php acs_animacion(); ?>" class="resumen__bloque">
...
<section class="speakers">
    ...
    <p class="speakers__descripcion">Conoce a nuestros expertos de DevWevCamp</p>

    <div class="speakers__grid">

        <?php foreach ($ponentes as $ponente) { ?>
            <div data-aos="<?php acs_animacion(); ?>" class="speaker">
                <picture>
                    <source srcset="<?php echo $_ENV['HOST'] . '/img/speakers/' . $ponente->imagen; ?>.webp" type="image/webp">
                    <source srcset="<?php echo $_ENV['HOST'] . '/img/speakers/' . $ponente->imagen; ?>.png" type="image/png">
                    <img class="speaker__imagen" loading="lazy" width="200" height="300" src="<?php echo $_ENV['HOST'] . '/img/speakers/' . $evento->ponente->imagen; ?>.webp" alt="Imagen Ponente">
                </picture>
                ...
                <div class="speaker__informacion">
                    ...
                    <nav class="speaker-sociales">
                        ...
                        <?php if (!empty($redes->tiktok)) { ?>
                            <a class="speaker-sociales__enlace" rel="noopener noreferrer" target="_blank" href="<?php echo $tiktok; ?>">
...
<section class="boletos">
    ...
    <p class="boletos__descripcion">Precios para DevWevCamp</p>

    <div class="boletos__grid">
        <div data-aos="<?php acs_animacion(); ?>" class="boleto boleto--presencial">
            <h4 class="boleto__logo">&#60;DevWebCamp /></h4>
            <p class="boleto__plan">Presencial</p>
            <p class="boleto__precio">$199</p>
        </div>
        <div data-aos="<?php acs_animacion(); ?>" class="boleto boleto--virtual">
            <h4 class="boleto__logo">&#60;DevWebCamp /></h4>
            <p class="boleto__plan">Virtual</p>
            <p class="boleto__precio">$49</p>
        </div>
        <div data-aos="<?php acs_animacion(); ?>" class="boleto boleto--gratis">
            <h4 class="boleto__logo">&#60;DevWebCamp /></h4>
    ...
    <div class="boleto__enalce-contenedor">
